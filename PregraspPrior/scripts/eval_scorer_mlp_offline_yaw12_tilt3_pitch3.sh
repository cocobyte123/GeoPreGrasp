...
python3 -m oc_pregrasp.eval.eval_scorer_offline \
  --checkpoint /mnt/AAAI2027_grasp/PregraspPrior/data/models/scorer_mlp_pca_short_yaw12_tilt3_pitch3_scene/best.pt \
  --rollout-root /mnt/AAAI2027_grasp/PregraspPrior/data/rollouts/pca_short_yaw12_tilt3_pitch3_scene \
  --output-json /mnt/AAAI2027_grasp/PregraspPrior/data/evals/scorer_mlp_pca_short_yaw12_tilt3_pitch3_scene_offline.json \
